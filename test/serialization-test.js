...
describe('serialization',function(){
    ...
    describe('json',function(){
        ...
        it('should create generate valid JSON for empty object',function(){
            ...
            obj.date = null;
            obj.timestamp = null;
            var json = '{"id":'+obj.objectID.recordId()+',"awakeFromInsertValue":"awaken","awakeFromFetchValue":null,"saveValue":null,"uuid":"'+obj.uuid+'","name":"defVal","int":null,"bool":null,"decim":null,"float":null,"double":null,"email":null,"url":null,"enum":null,"date":null,"timestamp":null,"data":null,"shortString":null,"transformable":null,"firstname":"John","lastname":"Doe","fullName":"John Doe","fullName2":"John Doe","world_id":null}';
            assert.equal(JSON.stringify(obj.toJSON()),json);
        })
    })
})