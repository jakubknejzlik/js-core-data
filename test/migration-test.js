...
describe("migrations", function() {
  ...
  var userFriendsRelationshipName =
    "friends" + Math.round(Math.random() * 10000);
  ...
  before(function() {
    ...
    model1.defineRelationshipManyToOne(
      "User",
      "Company",
      "invalidCompany",
      "invalidUsers",
    ...
    model2.defineRelationshipManyToOne(
      "User",
      company2Name,
      "company2",
      "users2",
    ...
    model2.defineRelationshipOneToMany(
      "User",
      company2Name,
      "favoriteCompanies",
      "favoritedUser",
    ...
    model2.defineRelationshipManyToMany(
      "User",
      "User",
      userFriendsRelationshipName,
      userFriendsRelationshipName
    );
    model2.defineRelationshipManyToMany(
      "User",
    ...
    migration1to2.renameRelationship(
      "User",
      "friends",
      userFriendsRelationshipName
    );
