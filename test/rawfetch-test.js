  ...
  before(function(done) {
    ...
    db
      ...
      .then(function() {
        ...
        var user1 = context.create("User", {
          firstname: "John",
          lastname: "Doe"
        });
        var user2 = context.create("User", {
          firstname: "John2",
          lastname: "Doe2"
        });
        var user3 = context.create("User", {
          firstname: "John2",
          lastname: "Doe2"
        });
  ...
  it("fetch entity with fields", function(done) {
    ...
    context
      .fetch("User", {
        ...
        group: "SELF.company.name,SELF.firstname,SELF.lastname,SELF.id",
