...
(function() {
  var AttributeTransformer, FetchRequest, Lock, ManagedObject, ManagedObjectContext, ManagedObjectID, Predicate, RelationshipDescription, SortDescriptor, ac, async,
  ...
  ManagedObjectContext = (function(superClass) {
    ...
    ManagedObjectContext.prototype.getObjects = function(entityName, options, callback) {
      ...
      return this.storeCoordinator.execute(this._getFetchRequestRequest(entityName, options), this, (function(_this) {
        return function(err, objects) {
          if (!err) {
    ...
    ManagedObjectContext.prototype._getFetchRequestRequest = function(entityName, options) {
    ...
    ManagedObjectContext.prototype.getOrCreateObject = function(entityName, options, defaultValues, callback) {
      ...
      return this.lock(entityName, (function(_this) {
    ...
    ManagedObjectContext.prototype.getObjectsCount = function(entityName, options, callback) {
      ...
      return this.storeCoordinator.numberOfObjectsForFetchRequest(this._getFetchRequestRequest(entityName, options), callback);
    };
