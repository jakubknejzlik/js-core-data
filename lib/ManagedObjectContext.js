...
(function() {
  ...
  ManagedObjectContext = (function(superClass) {
    ...
    ManagedObjectContext.prototype._deleteObjectWithoutLockCheck = function(
      object
    ) {
      if (object.managedObjectContext !== this) {
    ...
    ManagedObjectContext.prototype.create = function(
      entityName,
      data,
      allowedAttributes
    ) {
    ...
    ManagedObjectContext.prototype.getObjectWithId = function(
      entityName,
      id,
      callback
    ) {
        ...
        (function(_this) {
          return function(resolve, reject) {
            return async.nextTick(function() {
              ...
              return _this
                .getObjectWithObjectID(new ManagedObjectID(id, entity))
                .then(resolve)
                ["catch"](reject);
            });
          };
    ...
    ManagedObjectContext.prototype.getObjectWithObjectID = function(
      ObjectID,
      callback
    ) {
      return new Promise(
    ...
    ManagedObjectContext.prototype.getObjects = function(
      entityName,
      options,
      callback
    ) {
    ...
    ManagedObjectContext.prototype.fetch = function(
      entityName,
      options,
      callback
    ) {
    ...
    ManagedObjectContext.prototype._getFetchRequest = function(
      entityName,
      options
    ) {
      var ascending,
    ...
    ManagedObjectContext.prototype.getObject = function(
      entityName,
      options,
      callback
    ) {
    ...
    ManagedObjectContext.prototype.getOrCreateObject = function(
      entityName,
      options,
      defaultValues,
      callback
        ...
        (function(_this) {
          return function(resolve, reject) {
            return _this.lock(entityName, function(release) {
              return _this.getObject(entityName, options, function(
                err,
                object
              ) {
                if (err) {
    ...
    ManagedObjectContext.prototype.getObjectsCount = function(
      entityName,
      options,
      callback
    ) {
    ...
    ManagedObjectContext.prototype._getObjectsForRelationship = function(
      relationship,
      object,
      context,
      callback
      ...
      return new Promise(
        (function(_this) {
          return function(resolve, reject) {
            ...
            allObjects = [];
            ref = _this.insertedObjects.concat(
