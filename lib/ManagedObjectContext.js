...
(function() {
  var AttributeTransformer, FetchRequest, Lock, ManagedObject, ManagedObjectContext, ManagedObjectID, Predicate, Q, RelationshipDescription, SortDescriptor, ac, async,
  ...
  ManagedObjectContext = (function(superClass) {
    ...
    ManagedObjectContext.prototype.getObjects = function(entityName, options, callback) {
      ...
      this.storeCoordinator.execute(this._getFetchRequestRequest(entityName, options), this, (function(_this) {
        return function(err, objects) {
          if (err) {
            return deferred.reject(err);
          } else {
    ...
    ManagedObjectContext.prototype.getObjectsCount = function(entityName, options, callback) {
      ...
      this.storeCoordinator.numberOfObjectsForFetchRequest(this._getFetchRequestRequest(entityName, options), function(err, count) {
        if (err) {
          return deferred.reject(err);
        } else {
