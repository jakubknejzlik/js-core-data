...
(function() {
  var DATE_FORMAT, ManagedObject, ManagedObjectID, Predicate, columnNameRegExp, moment, nanRegExp, numberRegExp, operators, util,
  ...
  Predicate = (function(superClass) {
    ...
    Predicate.prototype.escapeArrayValues = function(array) {
      return array.map(this.escapeValue);
    };
    ...
    Predicate.prototype.parseObjectCondition = function(object, join, tableAlias) {
      var _operator, i, item, key, len, operator, predicates, signature, string, value;
      if (join == null) {
        join = 'AND';
      }
      if (tableAlias == null) {
      ...
      if (Array.isArray(object)) {
        ...
        for (key in object) {
          ...
          if ((key !== '$or' && key !== '$and') && key.indexOf(tableAlias + '.') === -1) {
