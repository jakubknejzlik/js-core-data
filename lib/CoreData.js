...
(function() {
  ...
  CoreDataSeed = require("./CoreDataSeed");

  CoreDataSchema = require("./CoreDataSchema");
  ...
  converter = require("unit-converter");
  ...
  CoreData = (function() {
    ...
    function CoreData(storeURL, options1) {
      ...
      this.models = {};
      this.seed = new CoreDataSeed(this);
      this.schema = new CoreDataSchema(this);
    }
        ...
        (function(_this) {
          return function(resolve, reject) {
            return async.forEach(
              _this._persistentStoreCoordinator().persistentStores,
              function(store, cb) {
    ...
    CoreData.prototype.createModelFromYaml = function(
      yamlSource,
      objectClasses,
      modelVersion
    ) {
    ...
    CoreData.prototype.defineEntity = function(
      entityName,
      attributes,
      options
    ) {
    ...
    CoreData.prototype.defineRelationship = function(
      entity,
      destinationEntity,
      name,
      options
      ...
      return this._ensureModel().defineRelationship(
        entity,
        destinationEntity,
        name,
        options
    ...
    CoreData.prototype.defineRelationshipToMany = function(
      entity,
      destinationEntity,
      name,
      inverse,
      ...
      return this._ensureModel().defineRelationshipToMany(
        entity,
        destinationEntity,
        name,
        inverse,
    ...
    CoreData.prototype.defineRelationshipToOne = function(
      entity,
      destinationEntity,
      name,
      inverse,
      ...
      return this._ensureModel().defineRelationshipToOne(
        entity,
        destinationEntity,
        name,
        inverse,
    ...
    CoreData.prototype.defineRelationshipOneToMany = function(
      entity,
      destinationEntity,
      name,
      inverse,
      ...
      return this._ensureModel().defineRelationshipOneToMany(
        entity,
        destinationEntity,
        name,
        inverse,
    ...
    CoreData.prototype.defineRelationshipManyToOne = function(
      entity,
      destinationEntity,
      name,
      inverse,
      ...
      return this._ensureModel().defineRelationshipManyToOne(
        entity,
        destinationEntity,
        name,
        inverse,
    ...
    CoreData.prototype.defineRelationshipManyToMany = function(
      entity,
      destinationEntity,
      name,
      inverse,
      ...
      return this._ensureModel().defineRelationshipManyToMany(
        entity,
        destinationEntity,
        name,
        inverse,
    ...
    CoreData.prototype._persistentStoreCoordinator = function() {
      if (!this.persistentStoreCoordinator) {
        this.persistentStoreCoordinator = new PersistentStoreCoordinator(
          this.model,
          this.options
        );
    ...
    CoreData.prototype.middleware = function(options) {
      var destroyTimeout;
      options = options || {};
      destroyTimeout = converter
        .convert(options.destroyTimeout || "10s")
        .to("ms");
      return (function(_this) {
        return function(req, res, next) {
          ...
          res.once("close", function() {
            ...
            if (_this.options.logging) {
              _this.options.logging(
                "destroying context timeout (close): ",
                destroyTimeout
              );
            }
          ...
          res.once("finish", function() {
            ...
            if (_this.options.logging) {
              _this.options.logging(
                "destroying context timeout (finish): ",
                destroyTimeout
              );
            }
            return setTimeout(function() {
