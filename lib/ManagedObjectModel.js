...
(function() {
  ...
  ManagedObjectModel = (function(superClass) {
    ...
    function ManagedObjectModel(scheme, modelClasses, version1) {
      if (scheme == null) {
        scheme = null;
      }
    ...
    ManagedObjectModel.prototype.getMigrationFrom = function(version) {
      return console.log(this.findMigrations(version));
    };

    ManagedObjectModel.prototype.findMigrations = function(version, migrations) {
      var i, len, migration, migrationArray, ref;
      if (migrations == null) {
        migrations = [];
      }
      ref = this.migrations;
    ...
    ManagedObjectModel.prototype.defineRelationshipOneToMany = function(entity, destinationEntity, name, inverse) {
      this.defineRelationshipToOne(destinationEntity, entity, inverse, name);
      return this.defineRelationshipToMany(entity, destinationEntity, name, inverse);
    };

    ManagedObjectModel.prototype.defineRelationshipManyToOne = function(entity, destinationEntity, name, inverse) {
      this.defineRelationshipToMany(destinationEntity, entity, inverse, name);
      return this.defineRelationshipToOne(entity, destinationEntity, name, inverse);
    };
