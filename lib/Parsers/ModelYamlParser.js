...
(function() {
  ...
  ModelYamlParser = (function(superClass) {
    ...
    ModelYamlParser.fillModelFromYaml = function(objectModel, yamlSource) {
      var _entities, attr, attributeInfo, attributeKey, e, entities, entitiesArray, entity, entityName, i, info, len, ref, ref1, relationship, relationshipInfo, relationshipName, results;
      try {
        entities = {};
        entitiesArray = [];
        ...
        for (entityName in _entities) {
          info = _entities[entityName];
          ref1 = info.relationships || info.relations;
          for (relationshipName in ref1) {
            relationshipInfo = ref1[relationshipName];
