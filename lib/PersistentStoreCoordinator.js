...
(function() {
  var AttributeTransformer, FetchRequest, IncrementalStore, ManagedObject, PersistentStoreCoordinator, PersistentStoreRequest, Predicate, _knownStoreProtocols, ac, async, url,
  ...
  PersistentStoreCoordinator = (function(superClass) {
    ...
    PersistentStoreCoordinator.prototype._executeNextRequestIfPossible = function() {
      ...
      return store.execute(request, context, (function(_this) {
        return function(err, ObjectIDs, objectValues) {
