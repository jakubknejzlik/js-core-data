...
PersistentStoreCoordinator = (function(superClass) {
  ...
  PersistentStoreCoordinator.registerStoreClass = function(
    storeClass,
    storeType
  ) {
  ...
  PersistentStoreCoordinator.prototype.addStore = function(
    storeTypeOrStore,
    URL,
    callback
  ) {
  ...
  PersistentStoreCoordinator.prototype.execute = function(
    request,
    context,
    callback
  ) {
  ...
  PersistentStoreCoordinator.prototype._executeNextRequestIfPossible = function() {
    ...
    if (
      request.type === "fetch" &&
      ((ref = request.predicate) != null ? ref.isObjectIDPredicate() : void 0)
    ) {
            ...
            if (obj) {
              ...
              objects.push(
                _this._objectForID(
                  ...
                  context,
                  objectID,
                  objectValues[objectID.toString()]
                )
              );
            }
          }
  ...
  PersistentStoreCoordinator.prototype.numberOfObjectsForFetchRequest = function(
    request,
    callback
  ) {
    var store;
  ...
  PersistentStoreCoordinator.prototype._requestCompleted = function(
    callback,
    err,
    objects
  ) {
  ...
  PersistentStoreCoordinator.prototype._objectForID = function(
    entity,
    context,
    objectID,
    objectValues
  ...
  PersistentStoreCoordinator.prototype._objectFromContextCache = function(
    context,
    objectID
  ) {
  ...
  PersistentStoreCoordinator.prototype.saveContext = function(
    context,
    callback
  ) {
          ...
          return store.execute(
            ...
            (function(_this) {
              return function() {
                ...
                permanentObjectIDs = store.permanentIDsForObjects(
  ...
  PersistentStoreCoordinator.prototype._valuesForForRelationship = function(
    relationship,
    ObjectID,
    context,
    callback
    ...
    request = new FetchRequest(
      inversedRelationship.entity,
      new Predicate(
        "SELF." +
          inversedRelationship.name +
          "." +
  ...
  PersistentStoreCoordinator.prototype.temporaryObjectID = function(object) {
    var id;
    id = this.persistentStores[0].newObjectID(
      object.entity,
      this.temporaryId++
    );
