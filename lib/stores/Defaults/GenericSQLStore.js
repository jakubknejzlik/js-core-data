...
(function() {
  ...
  GenericSQLStore = (function(superClass) {
    ...
    GenericSQLStore.prototype.createMigrationQueries = function(migration) {
      var addedEntitiesNames, attribute, change, e, entityChangedNames, entityFrom, entityName, entityTo, error, error1, inverseRelationship, j, k, l, len, len1, len2, len3, len4, len5, len6, len7, m, modelFrom, modelTo, n, newAttribute, newInverseRelationship, newReflexiveRelationship, newReflexiveTableName, newRelationship, o, p, q, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, reflexiveRelationship, reflexiveTableName, relationship, sqls, updatedEntities;
      sqls = [];
      entityChangedNames = {};
      addedEntitiesNames = [];
      ...
      for (k = 0, len1 = updatedEntities.length; k < len1; k++) {
        ...
        if (entityFrom) {
          ...
          for (p = 0, len6 = ref11.length; p < len6; p++) {
            relationship = ref11[p];
            inverseRelationship = relationship.inverseRelationship();
        ...
        if (entityTo) {
          ref14 = entityTo.relationships;
          for (q = 0, len7 = ref14.length; q < len7; q++) {
            relationship = ref14[q];
            inverseRelationship = relationship.inverseRelationship();
            if (relationship.toMany && inverseRelationship.toMany) {
