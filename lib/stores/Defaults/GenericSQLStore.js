  ...
  GenericSQLStore = (function(superClass) {
    ...
    GenericSQLStore.prototype.sqlForFetchRequest = function(request) {
      ...
      if (request.havingPredicate) {
        console.log('!!?', this.parseHavingPredicate(request.havingPredicate));
        query.having(this.parseHavingPredicate(request.havingPredicate));
      }
      if (request.limit) {
    ...
    GenericSQLStore.prototype.parseHavingPredicate = function(predicate) {
      var string;
      return predicate.toString();
      string = predicate.toString();
      string = string.replace(new RegExp(this.tableAlias + '.', 'g'), '');
      return string;
    };
    ...
    GenericSQLStore.prototype.processQuery = function(query, request) {
      var column, columnAfter, columnRegExp, fieldName, fieldValue, j, len, match, matches, ref, regString;
