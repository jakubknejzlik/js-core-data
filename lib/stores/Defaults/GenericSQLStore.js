...
(function() {
  ...
  GenericSQLStore = (function(superClass) {
    ...
    GenericSQLStore.prototype._formatManyToManyRelationshipTableName = function(relationship) {
      var inverseRelationship, reflexiveRelationship;
      inverseRelationship = relationship.inverseRelationship();
      reflexiveRelationship = this._relationshipByPriority(relationship, inverseRelationship);
      return this._formatTableName(reflexiveRelationship.entity.name) + '_' + reflexiveRelationship.name;
    };
    ...
    GenericSQLStore.prototype.syncSchema = function(options, callback) {
      ...
      return this.getCurrentVersion((function(_this) {
        return function(err, currentVersion) {
          ...
          if (currentVersion === objectModel.version) {
            return callback();
