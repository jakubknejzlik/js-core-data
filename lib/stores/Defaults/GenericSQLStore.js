    ...
    GenericSQLStore.prototype.createMigrationQueries = function(migration) {
      ...
      for (k = 0, len1 = updatedEntities.length; k < len1; k++) {
        ...
        for (m = 0, len3 = ref2.length; m < len3; m++) {
          relationship = ref2[m];
          if (!relationship.toMany) {
            change = (ref3 = migration.relationshipsChanges[entityName]) != null ? ref3[relationship.name] : void 0;
            if (change) {
              if (change !== '-' && change !== '+') {
      ...
      ref4 = entityTo.relationships;
      for (n = 0, len4 = ref4.length; n < len4; n++) {
        relationship = ref4[n];
        inversedRelationship = relationship.inverseRelationship();
        if (relationship.toMany && inversedRelationship.toMany) {
          change = (ref5 = migration.relationshipsChanges[entityName]) != null ? ref5[relationship.name] : void 0;
          if (change) {
            if (change !== '+' && change !== '-') {
