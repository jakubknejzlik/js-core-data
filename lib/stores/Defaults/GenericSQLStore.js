    ...
    GenericSQLStore.prototype.syncSchema = function(options, callback) {
      ...
      return this.getCurrentVersion((function(_this) {
        return function(err, version) {
          var queries;
          if (!version && !options.ignoreVersion && !options.force) {
            return callback(new Error('current version not found, rerun syncSchema with enabled option ignoreVersion'));
          } else if (version !== _this.storeCoordinator.objectModel.version || options.ignoreVersion || options.force) {
            try {
            ...
            return callback(new Error('migrations not implemented'));
          }
        };
      })(this));
    };
