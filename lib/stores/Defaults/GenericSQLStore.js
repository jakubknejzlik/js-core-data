...
(function() {
  ...
  GenericSQLStore = (function(superClass) {
    ...
    GenericSQLStore.prototype.createMigrationQueries = function(migration) {
        ...
        if (entityFrom) {
          ...
          for (n = 0, len4 = ref5.length; n < len4; n++) {
            ...
            if (!relationship.toMany || !inverseRelationship.toMany) {
              change = ((ref6 = migration.relationshipsChanges[entityName]) != null ? ref6[relationship.name] : void 0) || ((ref7 = migration.relationshipsChanges[inverseRelationship.entity.name]) != null ? ref7[inverseRelationship.name] : void 0);
              if (relationship.toMany) {
      ...
      ref15 = modelTo.entities;
      for (entityName in ref15) {
        entityTo = ref15[entityName];
        if (entityTo && (ref16 = entityTo.name, indexOf.call(addedEntitiesNames, ref16) < 0)) {
          ref17 = entityTo.relationships;
          for (r = 0, len8 = ref17.length; r < len8; r++) {
            relationship = ref17[r];
            inverseRelationship = relationship.inverseRelationship();
            if (!relationship.toMany) {
        ...
        ref20 = entityTo.relationships;
        for (s = 0, len9 = ref20.length; s < len9; s++) {
          relationship = ref20[s];
          inverseRelationship = relationship.inverseRelationship();
          if (relationship.toMany && inverseRelationship.toMany) {
            change = ((ref21 = migration.relationshipsChanges[entityName]) != null ? ref21[relationship.name] : void 0) || ((ref22 = migration.relationshipsChanges[inverseRelationship.entity.name]) != null ? ref22[inverseRelationship.name] : void 0);
            if (change === '+') {
