...
(function() {
  ...
  GenericSQLStore = (function(superClass) {
    ...
    GenericSQLStore.prototype.sqlForFetchRequest = function(request) {
      var allFieldsMark, attribute, column, columnName, descriptor, descriptors, field, fields, j, k, l, len, len1, len2, len3, len4, m, n, name, query, ref, ref1, ref2, ref3, ref4, ref5, relationship, sqlString;
      query = squel.select({
        autoQuoteAliasNames: false
      }).from(this._formatTableName(request.entity.name), this.tableAlias);
      if (request.resultType === FetchRequest.RESULT_TYPE.MANAGED_OBJECTS) {
        ...
        if (!request.fields) {
          ...
          if (allFieldsMark) {
            ...
            ref4 = request.entity.getNonTransientAttributes();
      ...
      if (Array.isArray(request.sortDescriptors) && request.sortDescriptors.length > 0) {
        ...
        for (n = 0, len4 = descriptors.length; n < len4; n++) {
    ...
    GenericSQLStore.prototype._getRawTranslatedQueryWithJoins = function(query, request) {
      var _subkeys, alreadyJoined, clearedSQLString, fieldName, fieldValue, i, j, joinMatches, joins, key, leftJoin, len, match, ref, replaceNameSorted, replaceNames, sqlString;
      replaceNames = {};
      joins = {};
