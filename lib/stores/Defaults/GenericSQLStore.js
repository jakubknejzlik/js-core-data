...
(function() {
  ...
  GenericSQLStore = (function(superClass) {
    ...
    GenericSQLStore.prototype.numberOfObjectsForFetchRequest = function(request, callback) {
      return this.connectionPool.query(this.countSqlForFetchRequest(request), (function(_this) {
        return function(err, result) {
          var ref;
          return callback(err, result != null ? (ref = result[0]) != null ? ref.count : void 0 : void 0);
        };
      })(this));
    };
    ...
    GenericSQLStore.prototype.createMigrationQueries = function(migration) {
      var attribute, change, e, entityChangedNames, entityFrom, entityName, entityTo, error, error1, inversedRelationship, j, k, l, len, len1, len2, len3, len4, m, modelFrom, modelTo, n, newColumnNames, oldAttribute, oldColumnNames, oldInversedRelationship, oldReflexiveRelationship, oldReflexiveTableName, oldRelationship, ref, ref1, ref2, ref3, ref4, ref5, ref6, reflexiveRelationship, reflexiveTableName, relationship, sqls, tableName, tmpTableName, updatedEntities;
      sqls = [];
      entityChangedNames = {};
