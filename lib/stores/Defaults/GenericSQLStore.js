...
(function() {
  var GenericPool, GenericSQLStore, IncrementalStore, ManagedObjectID, PersistentStoreRequest, Predicate, SortDescriptor, _, async, squel,
  ...
  GenericSQLStore = (function(superClass) {
    ...
    GenericSQLStore.prototype.updateQueryForUpdatedObject = function(updatedObject) {
      var attribute, formattedTableName, id, key, updateValues, updates, value, values;
