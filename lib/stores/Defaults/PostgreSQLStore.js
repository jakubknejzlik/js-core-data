...
(function() {
  ...
  PostgreSQLStore = (function(superClass) {
    ...
    PostgreSQLStore.prototype.createSchemaQueries = function(options) {
      var entity, i, key, len, objectModel, ref, ref1, ref2, ref3, relationship, sqls;
      if (options == null) {
        options = {};
      }
      ...
      for (key in ref2) {
        ...
        for (i = 0, len = ref3.length; i < len; i++) {
          ...
          if (!relationship.toMany) {
            sqls.push('ALTER TABLE "' + this._formatTableName(entity.name) + '" ADD CONSTRAINT "' + this._formatTableName(entity.name) + '_' + relationship.name + '__fk" FOREIGN KEY ("' + relationship.name + '_id")  REFERENCES "' + this._formatTableName(relationship.destinationEntity.name) + '"("_id") ON DELETE ' + relationship.getOnDeleteRule());
          }
        }
      }
