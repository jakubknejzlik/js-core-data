    ...
    PostgreSQLStore.prototype.createRelationshipQueries = function(relationship, force) {
      ...
      if (relationship.toMany) {
        ...
        if (inversedRelationship.toMany) {
          ...
          parts.push('CONSTRAINT "fk_' + this._formatTableName(reflexiveRelationship.destinationEntity.name) + '_' + reflexiveRelationship.inverseRelationship().name + '_id" FOREIGN KEY ("reflexive") REFERENCES "' + this._formatTableName(reflexiveRelationship.entity.name) + '"("_id") ON DELETE CASCADE');
