...
(function() {
  ...
  PostgreSQLStore = (function(superClass) {
    ...
    PostgreSQLStore.prototype.decodeValueForAttribute = function(value, attribute) {
      switch (attribute.persistentType) {
        case 'datetime':
        case 'date':
      ...
      return PostgreSQLStore.__super__.decodeValueForAttribute.call(this, value, attribute);
    };
