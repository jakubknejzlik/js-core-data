...
(function() {
  ...
  PostgreSQLStore = (function(superClass) {
    ...
    PostgreSQLStore.prototype.createSchemaQueries = function(options, transaction, callback) {
      var entity, err, error2, i, key, len, objectModel, ref, ref1, ref2, ref3, relationship, sqls;
      if (options == null) {
        options = {};
      }
        ...
        for (key in ref2) {
          ...
          for (i = 0, len = ref3.length; i < len; i++) {
            ...
            if (!relationship.toMany) {
              sqls.push('ALTER TABLE "' + this._formatTableName(entity.name) + '" ADD CONSTRAINT "fk_' + this._formatTableName(entity.name) + '_' + relationship.name + '_id" FOREIGN KEY ("' + relationship.name + '_id")  REFERENCES "' + this._formatTableName(relationship.destinationEntity.name) + '"("_id") ON DELETE ' + relationship.getOnDeleteRule());
            }
          }
        }
