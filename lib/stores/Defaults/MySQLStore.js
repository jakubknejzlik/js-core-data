...
(function() {
  ...
  MySQLStore = (function(superClass) {
    ...
    MySQLStore.prototype._renameRelationshipQuery = function(tableName, relationshipFrom, relationshipTo) {
      return 'ALTER TABLE ' + this.quoteSymbol + tableName + this.quoteSymbol + ' CHANGE ' + this.quoteSymbol + relationshipFrom.name + '_id' + this.quoteSymbol + ' ' + this.quoteSymbol + relationshipFrom.name + '_id' + this.quoteSymbol + ' int(11) DEFAULT NULL';
    };
