    ...
    Transaction.prototype.sendQuery = function(query, params, callback) {
      ...
      return this.ensureBegin((function(_this) {
        return function(err) {
          ...
          if ((ref = _this.connection.store) != null ? (ref1 = ref.globals) != null ? ref1.logging : void 0 : void 0) {
            if ((ref2 = _this.connection.store) != null) {
              if ((ref3 = ref2.globals) != null) {
                ref3.logging(q);
              }
            }
          }
          return _this.connection.query(q, params, callback);
        };
      })(this));
    };
