...
ManagedObject = (function(superClass) {
  ...
  ManagedObject.prototype.setValues = function(
    values,
    allowedAttributes,
    options
  ) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (
        values[attributeDescription.name] !== void 0 &&
        (!allowedAttributes ||
          ((ref1 = attributeDescription.name),
          indexOf.call(allowedAttributes, ref1) >= 0)) &&
        (!attributeDescription.isPrivate() ||
          options.privates ||
          (allowedAttributes &&
            ((ref2 = attributeDescription.name),
            indexOf.call(allowedAttributes, ref2) >= 0)))
      ) {
        results.push(
  ...
  ManagedObject.addAttributeDescription = function(attributeDescription) {
    ...
    if (!attributeDescription.isTransient()) {
      this.prototype["get" + capitalizedName] =
        this.prototype["get" + capitalizedName] ||
        function() {
          return this["_get" + capitalizedName]();
        };
      this.prototype["set" + capitalizedName] =
        this.prototype["set" + capitalizedName] ||
        function(value) {
  ...
  ManagedObject.addRelationshipDescription = function(relationshipDescription) {
    var capitalizedName,
      capitalizedSingularizedName,
      inverseRelationship,
      inverseRelationshipCapitalizedName,
      singularizedName;
    ...
    if (!relationshipDescription.toMany) {
            ...
            return function(resolve, reject) {
              ...
              return async.nextTick(function() {
                if (_this._data[relationshipDescription.name] === void 0) {
                  return _this.managedObjectContext._getObjectsForRelationship(
                    relationshipDescription,
                    _this,
                    _this.managedObjectContext,
      ...
      this.prototype["add" + capitalizedSingularizedName] =
        this.prototype["add" + capitalizedSingularizedName] ||
        function(object) {
          return this["_add" + capitalizedSingularizedName](object);
        };
      this.prototype["add" + capitalizedName] =
        this.prototype["add" + capitalizedName] ||
        function(objects) {
          return this["_add" + capitalizedName](objects);
        };
      this.prototype["remove" + capitalizedSingularizedName] =
        this.prototype["remove" + capitalizedSingularizedName] ||
        function(object) {
          return this["_remove" + capitalizedSingularizedName](object);
        };
      this.prototype["remove" + capitalizedName] =
        this.prototype["remove" + capitalizedName] ||
        function(objects) {
          return this["_remove" + capitalizedName](objects);
        };
      this.prototype["_get" + capitalizedName] = this.prototype[
              ...
              if (!Array.isArray(_this._data[relationshipDescription.name])) {
                return _this.managedObjectContext._getObjectsForRelationship(
                  ...
                  function(err, objects) {
                    ...
                    return resolve(
                      _this._data[relationshipDescription.name].slice(0)
                    );
                  }
                );
              } else {
      ...
      this.prototype["_add" + capitalizedName] = this.prototype[
      ...
      this.prototype["_remove" + capitalizedSingularizedName] = function(
        object
      ) {
        if (!(object instanceof ManagedObject)) {
          throw new Error(
      ...
      this.prototype["_remove" + capitalizedName] = this.prototype[
  ...
  ManagedObject.prototype._setObjectToRelation = function(
    object,
    relationshipDescription,
  ...
  ManagedObject.prototype._addObjectToRelation = function(
    object,
    relationshipDescription,
    inversedRelationshipDescription,
    noRecursion
    ...
    if (
      ...
      indexOf.call(this._data[relationshipDescription.name], object) < 0
    ) {
      this._relationChanges = this._relationChanges || {};
  ...
  ManagedObject.prototype._removeObjectFromRelation = function(
    object,
    relationshipDescription,
    inversedRelationshipDescription,
    noRecursion,
