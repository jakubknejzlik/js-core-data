  ...
  ManagedObject = (function(superClass) {
          ...
          if (!Array.isArray(this._data[relationshipDescription.name])) {
            this.managedObjectContext._getObjectsForRelationship(relationshipDescription, this, this.managedObjectContext, (function(_this) {
              return function(err, objects) {
                ...
                return deferred.resolve(_this._data[relationshipDescription.name].slice(0));
              };
            })(this));
          } else {
            deferred.resolve(this._data[relationshipDescription.name].slice(0));
          }
          return deferred.promise.nodeify(callback);
        };
    ...
    ManagedObject.prototype._addObjectToRelation = function(object, relationshipDescription, inversedRelationshipDescription, noRecursion) {
      ...
      if (!this._data[relationshipDescription.name] || indexOf.call(this._data[relationshipDescription.name], object) < 0) {
        ...
        if (this._relationChanges['removed_' + relationshipDescription.name] && indexOf.call(this._relationChanges['added_' + relationshipDescription.name], object) < 0) {
    ...
    ManagedObject.prototype._removeObjectFromRelation = function(object, relationshipDescription, inversedRelationshipDescription, noRecursion, fireEvent) {
      ...
      if (!this._data[relationshipDescription.name] || indexOf.call(this._data[relationshipDescription.name], object) >= 0) {
        ...
        if (this._relationChanges['added_' + relationshipDescription.name] && indexOf.call(this._relationChanges['removed_' + relationshipDescription.name], object) < 0) {
