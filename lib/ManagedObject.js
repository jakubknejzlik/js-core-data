...
(function() {
  var AttributeTransformer, AttributeValidator, ManagedObject, ManagedObjectID, Q, RelationshipDescription, _, ac, capitalizedString,
    ...
    ManagedObject.addRelationshipDescription = function(relationshipDescription) {
      ...
      if (!relationshipDescription.toMany) {
        this.prototype['get' + capitalizedSingularizedName + 'ID'] = function() {
          ...
          return this._data[singularizedName + '_id'];
        };
